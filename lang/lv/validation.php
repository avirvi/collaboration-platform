...
return [
    ...
    'ascii' => ':attribute laukā drīkst būt tikai ASCII rakstzīmes un simboli.',
    ...
    'doesnt_end_with' => ':attribute laukam nedrīkst beigties ar: :values.',
    'doesnt_start_with' => ':attribute laukam nedrīkst sākties ar: :values.',
    'email' => ':attribute laukam jābūt derīgai e-pasta adresei.',
    'ends_with' => ':attribute laukam jābeidzas ar vienu no: :values.',
    'enum' => 'Izvēlētais :attribute nav derīgs.',
    'exists' => 'Izvēlētais :attribute nav derīgs.',
    'extensions' => ':attribute laukam jābūt ar vienu no paplašinājumiem: :values.',
    ...
    'gt' => [
        ...
        'string' => ':attribute laukam jābūt garākam par :value rakstzīmēm.',
    ],
    'gte' => [
        'array' => ':attribute laukā jābūt vismaz :value vienībām.',
        ...
        'string' => ':attribute laukam jābūt garākam vai vienādam ar :value rakstzīmēm.',
    ],
    ...
    'in_array' => ':attribute laukam jāeksistē :other laukā.',
    ...
    'lt' => [
        ...
        'string' => ':attribute laukam jābūt īsākam par :value rakstzīmēm.',
    ],
    'lte' => [
        'array' => ':attribute laukā nedrīkst būt vairāk par :value vienībām.',
        ...
        'string' => ':attribute laukam jābūt īsākam vai vienādam ar :value rakstzīmēm.',
    ],
    'mac_address' => ':attribute laukam jābūt derīgai MAC adresei.',
    'max' => [
        'array' => ':attribute laukā nedrīkst būt vairāk par :max vienībām.',
        'file' => ':attribute laukam nedrīkst būt lielākam par :max kilobaitiem.',
        'numeric' => ':attribute laukam nedrīkst būt lielākam par :max.',
        'string' => ':attribute laukam nedrīkst būt garākam par :max rakstzīmēm.',
    ],
    ...
    'missing' => ':attribute laukam jābūt iztrūkstošam.',
    'missing_if' => ':attribute laukam jābūt iztrūkstošam, kad :other ir :value.',
    'missing_unless' => ':attribute laukam jābūt iztrūkstošam, ja vien :other nav :value.',
    'missing_with' => ':attribute laukam jābūt iztrūkstošam, kad :values ir klāt.',
    'missing_with_all' => ':attribute laukam jābūt iztrūkstošam, kad :values ir klāt.',
    ...
    'password' => [
        'letters' => ':attribute laukā jābūt vismaz vienam burtam.',
        'mixed' => ':attribute laukā jābūt vismaz vienam lielajam un vienam mazajam burtam.',
        'numbers' => ':attribute laukā jābūt vismaz vienam ciparam.',
        'symbols' => ':attribute laukā jābūt vismaz vienam simbolam.',
        'uncompromised' => 'Dotais :attribute ir atrodams datu noplūdē. Lūdzu, izvēlies citu.',
    ],
    ...
    'prohibited_unless' => ':attribute lauks ir aizliegts, ja vien :other nav viens no :values.',
    'prohibits' => ':attribute lauks aizliedz :other esamību.',
    'regex' => ':attribute formāts nav derīgs.',
    'required' => ':attribute lauks ir obligāts.',
    'required_array_keys' => ':attribute laukā jābūt ierakstiem: :values.',
    ...
    'required_unless' => ':attribute lauks ir obligāts, ja vien :other nav viens no :values.',
    'required_with' => ':attribute lauks ir obligāts, kad :values ir klāt.',
    'required_with_all' => ':attribute lauks ir obligāts, kad visi :values ir klāt.',
    ...
    'starts_with' => ':attribute laukam jāsākas ar vienu no: :values.',
    ...
    'uppercase' => ':attribute laukam jābūt tikai lielajiem burtiem.',
